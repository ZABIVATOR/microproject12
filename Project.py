...
class Ui_Form3(object): #paralelepiped
...
class Window2(QMainWindow, Ui_Form):#input
	def __init__(self):
		super().__init__()
		self.v1=0.0
		self.v2=0.0
...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
		...
		self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(0, 10, 791, 71))
	...
	def retranslateUi(self, MainWindow):
		...
		self.pushButton_7.setText(_translate("MainWindow", "Параллелепипед"))
		self.pushButton_6.setText(_translate("MainWindow", "Шар"))
...
class MainWindow(QMainWindow, Ui_MainWindow):
	def __init__(self):
		...
		self.pushButton_6.clicked.connect(lambda:self.inpk(6))#shar
		self.pushButton_7.clicked.connect(lambda:self.inpp())#paralelepiped
